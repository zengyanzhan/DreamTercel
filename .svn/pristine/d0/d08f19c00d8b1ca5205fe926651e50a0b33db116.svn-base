...
},plugins:["draggable","droppable","resizable","pagination","tooltips","linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog"],parse:function(_2){
var aa=[];
...
(function($){
function init(_1c4){
$(_1c4).addClass("tooltips-f");
};
function _1c5(_1c6){
var opts=$.data(_1c6,"tooltips").options;
$(_1c6).unbind(".tooltips").bind(opts.showEvent+".tooltips",function(e){
_1cd(_1c6,e);
}).bind(opts.hideEvent+".tooltips",function(e){
_1d3(_1c6,e);
}).bind("mousemove.tooltips",function(e){
if(opts.trackMouse){
...
var _1cf=$.data(_1ce,"tooltips");
var opts=_1cf.options;
var tip=_1cf.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"tooltips\">"+"<div class=\"tooltips-content\"></div>"+"<div class=\"tooltips-arrow-outer\"></div>"+"<div class=\"tooltips-arrow\"></div>"+"</div>").appendTo("body");
_1cf.tip=tip;
_1d0(_1ce);
}
tip.removeClass("tooltips-top tooltips-bottom tooltips-left tooltips-right").addClass("tooltips-"+opts.position);
_1c8(_1ce);
_1cf.showTimer=setTimeout(function(){
_1c7(_1ce);
tip.show();
opts.onShow.call(_1ce,e);
var _1d1=tip.children(".tooltips-arrow-outer");
var _1d2=tip.children(".tooltips-arrow");
...
_1d8.tip.children(".tooltips-content").html(cc);
opts.onUpdate.call(_1d6,cc);
};
function _1d9(_1da){
var _1db=$.data(_1da,"tooltips");
if(_1db){
_1c8(_1da);
...
$.removeData(_1da,"tooltips");
$(_1da).unbind(".tooltips").removeClass("tooltips-f");
opts.onDestroy.call(_1da);
}
};
$.fn.tooltips=function(_1dc,_1dd){
if(typeof _1dc=="string"){
return $.fn.tooltips.methods[_1dc](this,_1dd);
}
_1dc=_1dc||{};
return this.each(function(){
var _1de=$.data(this,"tooltips");
if(_1de){
$.extend(_1de.options,_1dc);
}else{
$.data(this,"tooltips",{options:$.extend({},$.fn.tooltips.defaults,$.fn.tooltips.parseOptions(this),_1dc)});
init(this);
}
_1c5(this);
_1d0(this);
...
$.fn.tooltips.methods={options:function(jq){
return $.data(jq[0],"tooltips").options;
},tip:function(jq){
return $.data(jq[0],"tooltips").tip;
},arrow:function(jq){
return jq.tooltips("tip").children(".tooltips-arrow-outer,.tooltips-arrow");
},show:function(jq,e){
return jq.each(function(){
_1cd(this,e);
});
...
$.fn.tooltips.parseOptions=function(_1e0){
var t=$(_1e0);
...
$.fn.tooltips.defaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
t.find(".tooltips-f").each(function(){
...
$(_427).tooltips($.extend({},opts.tipOptions,{content:_428.message,position:opts.tipPosition,deltaX:opts.deltaX})).tooltips("show");
_428.tip=true;
};
function _429(_42a){
var _42b=$.data(_42a,"validatebox");
if(_42b&&_42b.tip){
$(_42a).tooltips("reposition");
}
};
function _425(_42c){
...
$(this).tooltips("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},onHide:function(){
$(this).tooltips("destroy");
