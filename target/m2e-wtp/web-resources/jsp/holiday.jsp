	...
	<script type="text/javascript">
		...
		function getdate(year)
		{
			...
			for ( var j = 1;j <= 12; j++) 
			{
				...
				// 年月以及星期
				datestr += "<table class='month' style='background-color:rgb(193,193,193);'>"
						+ "<tr style='background-color:rgb(193,193,193);'>" + "<td colspan='7'>"
						+ year + "年" + month + "月</td></tr>"
						+ "<tr style='background-color:rgb(193,193,193);'>" + "<td style='color:red'>日</td>"
						+ "<td>一</td>" + "<td>二</td>" + "<td>三</td>" + "<td>四</td>"
						+ "<td>五</td>" + "<td style='color:red'>六</td></tr>";
				// 循环每个月
				...
				<table align="right" style="padding:10px">
					<tr>
						<td style="width:100px">
							<input type="button" style="font:16px bold" value="减少一年" onmousedown="reduceyear()"  class="btn btn-info"/>
						</td>
						<td style="width:150px">
							<!--获得焦点后的验证事件：onfocus="checkyear()"-->
							<input type="text" style="background-color:#ecf0f5;font:16px bold" onmouseover="this.style.backgroundColor='#ecf0f5'"  class="form-control" maxlength="4" onchange="inputyear()" onkeypress="return notzhengze(this,event)" value="2017" id="year"/>
						</td>
						<td style="width:100px">
							<input type="button" style="font:16px bold" value="增加一年" onmousedown="raiseyear()"  class="btn btn-info"/>
						</td>
						<td width="90px" align="center">
							<input type="submit" style="font:16px bold" value="保存" onclick="senddate()" class="btn btn-info"/>
						</td>
						<td width="140px" >
							<input type="button" style="font:16px bold" value="取消所有选择假日" class="btn btn-info" onclick="cancelall()"/>
						</td>
						<td width="140px" >
							<input type="button" style="font:16px bold" value="选择所有假日" class="btn btn-info" onclick="selectallweekend()"/>
						</td>
					</tr>
				</table>
			</form>
		</div>
		<div id="date" data-placement="top"></div>
	</body>
</html>